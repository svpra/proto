...
{
    public class OwOPacketConverter
    {
        public static QtPacket Serialize(QtPacketType type, object obj, bool strict = false)
        {
            var t = QtPacketTypeManager.GetType(type);
            return Serialize(t.Item1, t.Item2, obj, strict);
        }

        public static QtPacket Serialize(byte type, byte subtype, object obj, bool strict = false)
        {
            ...
            var packet = QtPacket.Create(type, subtype);
        ...
        public static T Deserialize<T>(QtPacket packet, bool strict = false)
        {
